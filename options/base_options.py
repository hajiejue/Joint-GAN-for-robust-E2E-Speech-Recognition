...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--works_dir', help='path to work', default='/usr/home/wudamu/FP/kaldi-trunk/egs/aishell/s5/data')
        ...
        self.parser.add_argument('--resume', default='/usr/home/wudamu/FP/kaldi-trunk/egs/aishell/s5/data/playground/model.acc.best', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
        ...
        self.parser.add_argument('--feat_type', type=str, default='fft', help='feat_type')
