...
if __name__ == '__main__':
    ...
    in_json_file= "/usr/home/wudamu/FP/kaldi-trunk/egs/aishell/s5/data/test_for_cer/data.json"
    lm_path = "/usr/home/wudamu/Documents/Robust_e2e_gan-master/checkpoints/train_rnnlm_2layer_256_650_drop0.5_bs64"
    #rescore_weight = float(sys.argv[3])
    rescore_weight = 15
    #out_json_file = sys.argv[4]
    out_json_file ="/usr/home/wudamu/FP/kaldi-trunk/egs/aishell/s5/data/test_for_cer/data_rescore.json"
    print(sys.argv)
